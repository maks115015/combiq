...
<#assign sidebar>
    <@common.sidebar activeMenuItem='competence' />
</#assign>
...
<@templates.layoutWithSidebar
    ...
    <p>
        Во многих крупных компания ориентированных на разработку существуют
        внутренние документы, которые позволяют сопоставить уровень знаний соискателя
        с принятой в компании системой ранжирования сотрудников. Это позволяет
        упростить процесс приема на работу новых сотрудников, а так же определяет
        вилку заработной платы, в пределах которой компания будет готова сделать оффер.
    </p>
    <p>
        Предложенная ниже матрица компетенций это не истина в последней инстанции.
        Подойдите к ней критически. Если у вас есть информация, которая позволила бы
        улучшить матрицу, пожалуйста, сделайте <a
            href="https://github.com/blog/1943-how-to-write-the-perfect-pull-request">pull request</a> в
        <a href="https://github.com/atott/combiq">репозиторий сайта</a>.
    </p>
    ...
    <table class="co-table">
        <tbody>
        <tr>
            <th colspan="6">Computer Science</th>
        </tr>
        <tr class="headers">
            <td>&nbsp;</td>
            <td>Level 0</td>
            <td>Level 1 (D1, Junior)</td>
            <td>Level 2 (D2, Middle)</td>
            <td>Level 3 (D3, Senior)</td>
            <td>Comments</td>
        </tr>
        <tr class="q">
            ...
            <td>Knows space and time tradeoffs of the basic data structures, Arrays vs LinkedLists, Able to explain how
                hashtables can be implemented and can handle collisions, Priority queues and ways to implement them etc.
            </td>
            <td>Knowledge of advanced data structures like B-trees, binomial and fibonacci heaps, AVL/Red Black trees, Splay
                Trees, Skip Lists, tries etc.
            </td>
            <td></td>
        </tr>
        <tr class="q">
            <td>algorithms</td>
            <td>Unable to find the average of numbers in an array (It's hard to believe but I've interviewed such
                candidates)
            </td>
            <td>Basic sorting, searching and data structure traversal and retrieval algorithms</td>
            <td>Tree, Graph, simple greedy and divide and conquer algorithms, is able to understand the relevance of the
                levels of this matrix.
            </td>
            <td>Able to recognize and code dynamic programming solutions, good knowledge of graph algorithms, good knowledge
                of numerical computation algorithms, able to identify NP problems etc.
            </td>
        ...
        <tr class="q">
            ...
            <td>Basic understanding of compilers, linker and interpreters. Understands what assembly code is and how things
                work at the hardware level. Some knowledge of virtual memory and paging.
            </td>
            <td>Understands kernel mode vs. user mode, multi-threading, synchronization primitives and how they're
                implemented, able to read assembly code. Understands how networks work, understanding of network protocols
                and socket level programming.
            </td>
            <td>Understands the entire programming stack, hardware (CPU + Memory + Cache + Interrupts + microcode), binary
                code, assembly, static and dynamic linking, compilation, interpretation, JIT compilation, garbage
                collection, heap, stack, memory addressing...
            </td>
            <td></td>
        </tr>
        <tr>
            <th colspan="6">Software Engineering</th>
        </tr>
        <tr class="headers">
            <td>&nbsp;</td>
            <td>Level 0</td>
        ...
        <tr class="q">
            ...
            <td>Proficient in using CVS and SVN features. Knows how to branch and merge, use patches setup repository
                properties etc.
            </td>
        ...
        <tr class="q">
            ...
            <td>Can setup a script to build the system and also documentation, installers, generate release notes and tag
                the code in source control
            </td>
            <td></td>
        </tr>
        <tr class="q">
        ...
        <tr class="q">
            ...
            <td>Use of appropriate data structures and algorithms and comes up with generic/object-oriented code that
                encapsulate aspects of the problem that are subject to change.
            </td>
            <td></td>
        </tr>
        <tr class="q">
            ...
            <td>Able to visualize and design complex systems with multiple product lines and integrations with external
                systems. Also should be able to design operations support systems like monitoring, reporting, fail overs
                etc.
            </td>
            <td></td>
        </tr>
        <tr class="q">
            ...
            <td>This is an often under rated but very critical criteria for judging a programmer. With the increase in
                ...
                prominent. I know of several projects that failed because the programmers could not understand what the
        ...
        <tr class="q">
            ...
            <td>Code organization at a physical level closely matches design and looking at file names and folder
                distribution provides insights into design
            </td>
            <td></td>
        </tr>
        <tr class="q">
            ...
            <td>No circular dependencies, binaries, libs, docs, builds, third-party code all organized into appropriate
                folders
            </td>
            <td>Physical layout of source tree matches logical hierarchy and organization. The directory names and
                organization provide insights into the design of the system.
            </td>
            <td>The difference between this and the previous item is in the scale of organization, source tree organization
        ...
        <tr class="q">
            ...
            <td>Code assumptions are verified using asserts, code flows naturally - no deep nesting of conditionals or
                methods
            </td>
            <td></td>
        </tr>
        ...
        <tr class="q">
            ...
            <td>Ensures that error/exceptions leave program in good state, resources, connections and memory is all cleaned
                up properly
            </td>
            <td>Codes to detect possible exception before, maintain consistent exception handling strategy in all layers of
                code, come up with guidelines on exception handling for entire system.
            </td>
            <td></td>
        </tr>
        <tr class="q">
        ...
        <tr class="q">
            ...
            <td>Has written libraries that sit on top of the API to simplify frequently used tasks and to fill in gaps in
                the API
            </td>
        ...
        <tr class="q">
            ...
            <td>Has used more than one framework in a professional capacity and is well-versed with the idioms of the
                frameworks.
            </td>
        ...
        <tr class="q">
            ...
            <td>Able to design good and normalized database schemas keeping in mind the queries that'll have to be run,
                proficient in use of views, stored procedures, triggers and user defined types. Knows difference between
                clustered and non-clustered indexes. Proficient in use of ORM tools.
            </td>
            <td>Can do basic database administration, performance optimization, index optimization, write advanced select
                queries, able to replace cursor usage with relational sql, understands how data is stored internally,
        ...
        <tr class="q">
            ...
            <td>Imperative, Object-Oriented and declarative (SQL), added bonus if they understand static vs dynamic typing,
                weak vs strong typing and static inferred types
            </td>
        ...
        <tr class="q">
            ...
            <td>Domain expert. Has designed and implemented several products/solutions in the domain. Well versed with
        ...
        <tr class="q">
            ...
            <td>Good knowledge of editors, debuggers, IDEs, open source alternatives etc. etc. For e.g. someone who knows
                most of the tools from Scott Hanselman's power tools list. Has used ORM tools.
            </td>
        ...
        <tr class="q">
            ...
            <td>Has implemented multiple big features in the codebase and can easily visualize the changes required for most
        ...
        <tr class="q">
            ...
            <td>Has played with the previews and has actually built something with it and as a bonus shared that with
                everyone else
            </td>
            <td></td>
        </tr>
        ...
        <tr class="q">
            ...
            <td>Deep knowledge of platform internals and can visualize how the platform takes the program and converts it
                into executable code.
            </td>
            <td>Has written tools to enhance or provide information on platform internals. For e.g. disassemblers,
        ...
        <tr class="q">
            ...
            <td>Design Patterns, Peopleware, Programming Pearls, Algorithm Design Manual, Pragmatic Programmer, Mythical Man
                month
            </td>
            <td>Structure and Interpretation of Computer Programs, Concepts Techniques, Models of Computer Programming, Art
                of Computer Programming, Database systems , by C. J Date, Thinking Forth, Little Schemer
            </td>
            <td></td>
        </tr>
        <tr class="q">
